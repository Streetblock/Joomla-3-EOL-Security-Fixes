				...
				if ($profile->value) :
					...
					switch ($profile->id) :
						case 'profile_website':
							...
							if ($v_http === 'http') :
								echo '<dd><a href="' . $profile->text . '">' . $this->escape(JStringPunycode::urlToUTF8($profile->text)) . '</a></dd>';
							else :
								echo '<dd><a href="http://' . $profile->text . '">' . $this->escape(JStringPunycode::urlToUTF8($profile->text)) . '</a></dd>';
							endif;
							break;
