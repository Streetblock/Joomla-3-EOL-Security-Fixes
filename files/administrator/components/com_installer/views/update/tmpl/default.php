					...
					<table class="table table-striped">
						...
						<?php foreach ($this->items as $i => $item) : ?>
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<span class="editlinktip hasTooltip" title="<?php echo JHtml::_('tooltipText', JText::_('JGLOBAL_DESCRIPTION'), $this->escape($item->description ?: JText::_('COM_INSTALLER_MSG_UPDATE_NODESC')), 0); ?>">
